...
if not(os.path.isfile(jobDescriptionFile)):
	jobDescriptionFile = "job_descriptions/archive/" + jobTitle + ".txt"
...
jsonPath = "http://localhost:9999/AdamThompson/Resume/resumeContent.json"
...
# else:	
pdfName = "resumes/Adam Thompson Resume - " + jobTitle.title() + ".pdf"
