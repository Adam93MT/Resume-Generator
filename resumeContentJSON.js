resumeContent = {
	...
	},
	{
		...
		{	
			...
			tags: ["ux", "product design", "research", "ui", "sketch", "framer", "origami"]
		},
		{
		...
		},
		{
			...
			tags: ["ui", "product design", "ux", "sketch"]
		},
		{
	...
	},
	{
		...
		responsibilities: [
		{
		task: "Redesigned both iOS and Android apps from the ground up. I reworked everything from the registration workflow, to the in app experience at home and abroad using the KnowRoaming SIM Sticker.",
		tags: ["ux", "pm", "product", "design", "ucd"]
		},
		{
			task: "Leveraged customer feedback to iterate on the flow of the app to better correspond with the users' mental model of the 3 use-phases of the product.",
		...
		{
			task: "Started and lead weekly design meetings with developers, customer service, marketing and company leadership to discuss the experience of the mobile apps, consumer facing and corporate websites, and other relevant topics.",
