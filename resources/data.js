resumeContent = {
    ...
    "experience": [
        {
            ...
            "responsibilities": [
                "Designed the initial user experience wireframes and feature specifications for a hand replay feature expected to increase Daily Active Users", 
                "Perfromed background research, user analysis, and A/B testing as part of the design process for a new Subscriptions model", 
                "Configured final tuning parameters and UX flow for a viral engagement feature which increased Facebok feed app entry by 36%", 
        ...
        }, 
        {
            ...
            "responsibilities": [
                "Leveraged user testing results to re-design the meal-logging experience, improving clarity, speed of navigation and to better reflect the common mental model of logging food", 
                ...
                "Initiated multidisciplinary collaboration with all stakeholders to better understand product requirements, and managed the early design process for the coach dashboard"
            ], 
            "term": "Fall 2015", 
            "url": "noom.com"
        }, 
    ...
    "projects": [
        {
            "description": "A variable hearing protection device for periodically loud environments, such as construction sites and factories which continuously adjusts its attenuation based on the volume of the environment.", 
            "id": "fydp", 
            "name": "MADD.audio", 
            "responsibilities": [
                "Team lead & project manager", 
                "Developed and built a test apparatus and processing software"
            ], 
